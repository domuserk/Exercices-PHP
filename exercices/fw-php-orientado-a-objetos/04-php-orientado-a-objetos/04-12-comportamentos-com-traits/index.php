...
$user = new \Source\Traits\User("Ryan","Lopes","impcomercial.87@gmmail.com"

);
$address=new \Source\Traits\Address("Nome da Rua","123","Casa 11");
...
$cart->add(1,"Full Stack PHP DEVELOPER",1,1999);
$cart->add(2,"Laravel Developer",2,1111);
$cart->add(3,"WS PHP",5,2555);
$cart->remove(2,1);
$cart->remove(3,4);
