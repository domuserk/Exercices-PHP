...
INSERT INTO users(
                ...
                VALUES ('Ryan','Lopes','impcomercial.87@gmail.com','23222323');
";
try {
...
try {
    $exec=Connect::getInstance()->exec("UPDATE users SET first_name='Ryan',last_name='Lopes'
WHERE id='53' ");
var_dump($exec);
}catch (PDOException $exception){
    var_dump($exception);
...
try {
$exec=Connect::getInstance()->exec("DELETE FROM users WHERE id>53");
var_dump($exec);
}catch (PDOException $exception){
    var_dump($exception);
}